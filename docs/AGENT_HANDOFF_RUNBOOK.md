...
- Test mixed pending/work snapshots: ordinary pending decisions keep priority; red/yellow work beats only the explicit standing owner kinds. Parked must still open the exact valid owner hold, including a collapsed low-risk row, without reviewing or authorizing it. Verify first-paint / soft-paint parity and no invented destination when the hold or Decisions panel is absent.
