...
function run() {
  ...
  if (paint.indexOf('class="signal" data-open="work" href="https://github.com/rupret007/StoryBoard/pull/8"') === -1) {
    fail("first paint must tap StoryBoard PR #8 from the open-PR signal");
  }
  if (paint.indexOf('class="signal" data-open="work" href="https://github.com/rupret007/story-corner-shelf/pulls"') === -1) {
    fail("first paint must tap Closet shelf pulls list from 4 open PRs");
  }
  if (paint.indexOf('class="signal" data-open="work" href="https://github.com/rupret007/RadDadSite/pull/6"') === -1) {
    fail("first paint must tap RadDadSite PR #6 from the open-PR signal");
  }
